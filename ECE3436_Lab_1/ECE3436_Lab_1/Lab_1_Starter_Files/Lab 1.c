//ECE3436 Fall 2017
//Lab 1
//Name: put your name here or this looks silly.
...
//Install Putty, and set the BaudRate to 115200
//Included files
#include <stdint.h>
#include <stdbool.h>
#include <string.h>
...
uint8_t Find_Mean(void)
{
	//insert your code here to find the average of the temperature readings
	//-----------------------Begin---------------------------
...
uint8_t Find_Range(void)
{
	//insert your code here to find the range of the temperature readings
	//-----------------------Begin---------------------------
...
uint8_t IsMonotonic(void)
{
	//insert your code here to find if the series is monotonic or not
